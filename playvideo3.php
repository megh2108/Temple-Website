            ...
            <div class="row">
                <div class="play-video">
                    <div class="responsive">
                        <iframe src="online-rangoli-competition-Anand.mp4" title="YouTube video player" 
                        frameborder="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
                        allowfullscreen></iframe>
                    </div>
                    <h3>Online rangoli competition || Anand pathshala(19) and Vvnagar pathshala(13) birthday celebration</h3>
